...
> 社群里流传着一篇 gist《Stop making swap partitions—use swap files instead!》，核心主张是：swap 文件和 swap 分区的性能「二十多年没有差别」，因此 swap 文件「在各方面都更好」。这个结论对大多数场景成立，但它给出的理由站不住，适用范围也被写得太绝对。
