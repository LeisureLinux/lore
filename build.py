  ...
  <style>
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .share-bar {{
      ...
      padding: 18px 0 22px; margin-bottom: 8px;
      border-bottom: 1px dashed #E5E7EB;
    }}
    .share-label {{ font-size: 13px; color: #9CA3AF; font-weight: 600; margin-right: 2px; }}
    .share-btn {{
      display: flex; flex-direction: column; align-items: center; gap: 5px;
      background: none; border: none; cursor: pointer; padding: 0;
      font-family: inherit; color: #6B7280; font-size: 11px; line-height: 1;
    }}
    .share-btn:hover .share-ico {{ transform: translateY(-2px); }}
    .share-ico {{
      width: 40px; height: 40px; border-radius: 50%; color: #fff;
      display: flex; align-items: center; justify-content: center;
      font-weight: 700; font-size: 14px; transition: transform .15s ease;
  ...
  <main class="container">
    <article itemscope itemtype="https://schema.org/TechArticle">
      ...
      <div class="share-bar">
        ...
        <button type="button" class="share-btn" onclick="shareWechat()" title="微信扫码分享">
          <span class="share-ico ico-wx">微</span><span>微信</span>
        </button>
